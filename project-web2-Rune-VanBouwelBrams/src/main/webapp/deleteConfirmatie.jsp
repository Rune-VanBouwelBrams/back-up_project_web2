...
<div id="page-container">
    <div id="content-wrap">
        ...
        <main>
            ...
            <p>
                <a id="delete" href="Controller?command=delete&datum=${resultaat.datum}">Delete</a>
                <a id="cancel" href="Controller?command=overzicht">Cancel</a>
            </p>
        </main>
    </div>
