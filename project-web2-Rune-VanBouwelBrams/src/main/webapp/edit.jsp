...
<div id="page-container">
    <div id="content-wrap">
        ...
        <main>
            ...
            <form action="Controller" id="formulier" novalidate>
                <h3>Pas een resultaat aan.</h3>

                <label for="achternaam">Naam</label>
                <input name="achternaam" type="text" id="achternaam" value="${resultaat.achternaam}" required>

                <label for="voornaam">Voornaam</label>
                <input name="voornaam" type="text" id="voornaam" value="${resultaat.voornaam}" required>

                <label for="aantalEieren">Aantal eieren</label>
                <input name="aantalEieren" type="number" id="aantalEieren" value="${resultaat.aantalEieren}" required>

                <label for="datum">Datum</label>
                <input name="datum" type="date" id="datum" value="${resultaat.datum}" required>

                <label for="extraInfo">Extra info</label>
                <input name="extraInfo" type="text" id="extraInfo" value="${resultaat.extraInfo}">

                <input type="hidden" name="vorige" value="${resultaat.datum}">
